...
public class JstQueryPurchaseBookingResponse {
    ...
    public Integer getPageSize() {
        return data != null ? data.getPageSize() : null;
    }

    public Integer getPageIndex() {
        return data != null ? data.getPageIndex() : null;
    }

    public Boolean getHasNext() {
        return data != null ? data.getHasNext() : null;
    }

    public Integer getPageCount() {
        return data != null ? data.getPageCount() : null;
    }

    public Integer getDataCount() {
        return data != null ? data.getDataCount() : null;
    }
